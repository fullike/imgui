...
void init(struct android_app* app)
{
    ...
    std::vector<const char*> supportedInstanceExtensions = { "VK_KHR_surface", "VK_KHR_android_surface" };
    if (extCount > 0)
    {
    ...
    err = vkCreateAndroidSurfaceKHR(g_Instance, &surfaceCreateInfo, NULL, &surface);
